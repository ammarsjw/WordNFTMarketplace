...
export class Expired extends Entity {
  ...
  save(): void {
    ...
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        "Cannot save Expired entity with non-string ID. " +
          'Considering using .toHex() to convert the "id" to a string.'
      );
...
export class ERC721Received extends Entity {
  ...
  save(): void {
    ...
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        "Cannot save ERC721Received entity with non-string ID. " +
          'Considering using .toHex() to convert the "id" to a string.'
      );
...
export class ClaimedAndNoBidsMade extends Entity {
  ...
  save(): void {
    ...
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        "Cannot save ClaimedAndNoBidsMade entity with non-string ID. " +
          'Considering using .toHex() to convert the "id" to a string.'
      );
...
export class ChangedWordsNFTAddress extends Entity {
  ...
  save(): void {
    ...
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        "Cannot save ChangedWordsNFTAddress entity with non-string ID. " +
          'Considering using .toHex() to convert the "id" to a string.'
      );
...
export class ChangedMarketplaceFeeWallet extends Entity {
  ...
  save(): void {
    ...
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        "Cannot save ChangedMarketplaceFeeWallet entity with non-string ID. " +
          'Considering using .toHex() to convert the "id" to a string.'
      );
...
export class ChangedFeePercentages extends Entity {
  ...
  save(): void {
    ...
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        "Cannot save ChangedFeePercentages entity with non-string ID. " +
          'Considering using .toHex() to convert the "id" to a string.'
      );
...
export class BidMade extends Entity {
  ...
  save(): void {
    ...
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        "Cannot save BidMade entity with non-string ID. " +
          'Considering using .toHex() to convert the "id" to a string.'
      );
...
export class BidCancelled extends Entity {
  ...
  save(): void {
    ...
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        "Cannot save BidCancelled entity with non-string ID. " +
          'Considering using .toHex() to convert the "id" to a string.'
      );
...
export class AuctionMade extends Entity {
  ...
  save(): void {
    ...
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        "Cannot save AuctionMade entity with non-string ID. " +
          'Considering using .toHex() to convert the "id" to a string.'
      );
